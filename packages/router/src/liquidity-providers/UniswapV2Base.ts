...
export abstract class UniswapV2BaseProvider extends LiquidityProvider {
  ...
  topPools = new Map<Address, PoolCode>();
  poolsByTrade = new Map<string, Address[]>();
  onDemandPools = new Map<Address, PoolInfo>();
  availablePools = new Map<Address, PoolResponse2>();
  staticPools = new Map<Address, PoolResponse2>();
  ...
  async updatePools() {
    if (this.isInitialized) {
      ...
      void this.discoverNewPools();
      void this.updateAvailablePools();
