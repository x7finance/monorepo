  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium cursor-pointer transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none ring-offset-background focus-visible:ring-emerald-600",
  {
    variants: {
      variant: {
        ...
        outline:
          "border dark:border-muted hover:text-accent-foreground hover:bg-muted hover:border-muted-foreground border-muted-foreground",
        primary:
          "dark:bg-emerald-700/70 bg-emerald-700/90 border-2 border-emerald-700 hover:border-emerald-500 text-white hover:bg-emerald-900 hover:text-white",
        secondary:
    ...
    return (
      ...
      >
        <ButtonContent asChild={asChild}>
          {loading ? (
            <Loader2
              className={cn(buttonLoaderVariants({ size }), "relative right-2")}
            />
