...
class Fraction {
  ...
  public constructor(
    ...
    const { numerator: num, denominator: denom } = Fraction.parseFraction(
      numerator,
      denominator
    )
    this.numerator = num
  ...
  private static parseFraction(
    numerator: bigint | number | string | Fraction,
    denominator: bigint | number | string | Fraction
  ...
  private static parseValue(value: bigint | number | string | Fraction): {
    numerator: bigint
    denominator: bigint
  } {
  ...
  private static greatestCommonDivisor(a: bigint, b: bigint): bigint {
    if (b === 0n) return a
  ...
  public subtract(other: Fraction | bigint | number | string): Fraction {
    const otherFraction = new Fraction(other)
    return new Fraction(
      this.numerator * otherFraction.denominator -
        otherFraction.numerator * this.denominator,
  ...
  public lessThan(other: Fraction | bigint | number | string): boolean {
    const otherFraction = new Fraction(other)
    return (
      this.numerator * otherFraction.denominator <
      otherFraction.numerator * this.denominator
  ...
  public equalTo(other: Fraction | bigint | number | string): boolean {
    const otherFraction = new Fraction(other)
    return (
      this.numerator * otherFraction.denominator ===
      otherFraction.numerator * this.denominator
  ...
  public greaterThan(other: Fraction | bigint | number | string): boolean {
    const otherFraction = new Fraction(other)
    return (
      this.numerator * otherFraction.denominator >
      otherFraction.numerator * this.denominator
