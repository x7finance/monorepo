...
export function Medium(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" {...props}>
      ...
      />
      <path
        d="M18.0973 16.844C20.805 16.844 23 14.649 23 11.9413C23 9.23359 20.805 7.03857 18.0973 7.03857C15.3896 7.03857 13.1946 9.23359 13.1946 11.9413C13.1946 14.649 15.3896 16.844 18.0973 16.844Z"
        fill="currentColor"
      />
    </svg>
  )
