...
export function ThemeSelector(props: any) {
  let [selectedTheme, setSelectedTheme] = useState<any>(null);
  ...
  return (
    ...
    >
      ...
      <Listbox.Options className="absolute top-full left-1/2 mt-3 w-36 -translate-x-[9.5em] space-y-1 rounded-xl bg-white p-3 text-sm font-medium shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-slate-800 dark:ring-white/5">
