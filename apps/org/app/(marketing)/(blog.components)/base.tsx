  ...
  return (
    <>
      <div className="relative mx-auto max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="flex-auto w-full min-w-0 px-2 sm:pb-16 overflow-auto max-w-none lg:pl-8 lg:pr-0 xl:px-16">
          <Prose as="div" className="max-w-[1200px]">
            <>
              <div>
                <Link
                  className="absolute -top-14 xl:left-28 left- text-sm dark:text-zinc-400 dark:hover:text-zinc-200 text-zinc-600 hover:text-zinc-800"
                  href="/blog"
                >
                  ← Back to Blog
                </Link>
              ...
              {title && (
                <header className="space-y-1 sm:mb-9 mb-6 md:mx-auto lg:mx-0">
                  {!!tags?.length && (
                    <div className="flex flex-wrap items-center space-x-2 mb-6">
                      ...
                      {date && (
                        <h2 className="text-[14px] tracking-tight font-normal mt-0 mb-0 font-display text-zinc-500">
                          {date}
                        </h2>
                      )}
                    </div>
                  ...
                  {title && (
                    <h1 className="xl:text-5xl text-3xl font-bold font-heading">
                      {title}
                    </h1>
                  )}
                </header>
              ...
              {summary && (
                <div className="xl:text-2xl text-[16px] tracking-tighter text-zinc-500 leading-8 md:mx-auto lg:mx-0">
                  {summary}
                </div>
              )}
            </>
            <div className="pt-4 xl:hidden block">
          ...
          <div className="grid grid-cols-4 w-full mx-auto max-w-[1200px]">
            <ul
              role="list"
              className="xl:hidden border-b dark:border-zinc-800 border-zinc-200 w-full mx-auto max-w-2xl lg:max-w-full col-span-4 grid grid-cols-2 lg:grid-cols-3"
            >
              {authors?.map((a) => (
                <li key={`${a?.id}-author`} className="py-4 w-full">
                  <div className="flex items-center">
                    <Image
                      ...
                      height={80}
                      width={80}
                      className="sm:h-12 sm:w-12 h-8 w-8 sm:mr-3 mr-1.5 flex-none rounded-full ring-1 dark:ring-white/30 ring-black/30"
                    />
