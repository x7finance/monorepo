    ...
    <div className="py-24 sm:py-32">
      <div className="relative isolate">
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mx-auto flex max-w-2xl flex-col gap-16 bg-white/5 px-6 py-16 ring-1 ring-zinc-600 sm:rounded-3xl sm:p-8 lg:mx-0 lg:max-w-none lg:flex-row lg:items-center lg:py-20 xl:gap-x-20 xl:px-20 dark:ring-zinc-800">
            <Image
            ...
            <div className="w-full flex-auto">
              ...
              <p className="mt-6 text-lg leading-8 text-zinc-800 dark:text-zinc-300">
                {`Reach out to the X7 DAO below and we'll be happy to get
            you answers to any of the following and more.`}
              </p>
              <ul className="mt-10 grid grid-cols-1 gap-x-8 gap-y-3 text-base leading-7 text-black sm:grid-cols-2 dark:text-white">
              ...
              <div className="mt-10 flex">
                <LinkExternal
                  ...
                  className="text-sm leading-6 font-semibold text-emerald-700 dark:text-emerald-400"
                >
        ...
        >
          <div
            className="aspect-1318/752 w-[82.375rem] flex-none bg-linear-to-r from-[#000] to-[#4f46e5] opacity-50"
            style={{
              clipPath:
