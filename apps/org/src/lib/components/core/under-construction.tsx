...
export function UnderConstruction(props: ConstructionProps) {
      ...
      <div className="mx-auto mt-10">
        ...
        <div className="relative z-1 rounded-lg shadow-xl">
          ...
          <div className="absolute inset-x-0 top-0 translate-y-px transform">
            <div className="flex -translate-y-3/4 transform justify-center">
              <span
                className={cn(
                  GradientTypes.grape,
          ...
          <Image
            height={200}
            width={200}
            className="mx-auto h-auto w-32 overflow-hidden rounded-lg shadow-xs ring-1 ring-zinc-900/10 dark:ring-zinc-100/10"
  ...
  return (
    <div className="relative -top-10 isolate z-0 min-h-screen">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                  <div className="relative lg:grid lg:grid-cols-7">
                    ...
                    <div className="mx-auto mt-10 max-w-lg lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4 lg:mx-0 lg:mt-0 lg:max-w-none">
                      ...
                      <div className="relative z-1 rounded-lg shadow-xl">
                        <div
                          className="border-opacity-60 pointer-events-none absolute inset-0 rounded-lg border-2 border-emerald-600"
                          aria-hidden="true"
                        />
                        <div className="absolute inset-x-0 top-0 translate-y-px transform">
