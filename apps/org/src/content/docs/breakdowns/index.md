...
{% quickLink title="Variable Breakdowns" icon="presets" href="/docs/breakdowns/variables" description="View the specific parameter names and types of each function within our ecosystem." /%}
