...
To get started on Xchange, the first thing you'll need is to set up a wallet that supports Ethereum. Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
+++ Trust Wallet
[Install Trust Wallet](https://trustwallet.com/)
...
+++ Ledger (Hardware)
[Buy Ledger](https://www.ledger.com/)
Secure, grow your crypto and manage your NFTs with
