...
To get started on Xchange, the first thing you'll need is to set up a wallet that supports Polygon. Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
