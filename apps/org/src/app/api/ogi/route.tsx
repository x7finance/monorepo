...
export async function GET(req: NextRequest): Promise<ImageResponse> {
  try {
    ...
    // Adding type annotation for fontSize
    const fontSize: string =
      heading.length > 100 ? "46px" : isMain ? "72px" : "80px";

    // Adding type annotation for width
    const width: number = isMain ? 500 : 600;

    return new ImageResponse(
      (
        <div
          tw="flex relative text-xl flex-col p-10 w-full h-full items-start"
          style={{
            color: paint,
        ...
        >
              ...
              <li key={person}>
                <img
                  tw={classNames(
                    ...
                    "rounded-sm w-[280px] h-[280px] mr-4",
                  )}
          ...
          <div tw="w-full flex justify-end">
            <div tw="flex flex-col justify-center relative text-xl left-5 top-3">
              <svg
                width="270"
                height="106"
                viewBox="0 0 270 106"
