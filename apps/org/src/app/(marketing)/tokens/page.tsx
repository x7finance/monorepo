        ...
        <div className="mt-4 border-t border-zinc-900/5 pt-10 dark:border-white/5">
          <div className="grid grid-cols-2 gap-8">
            <div className="col-span-2 mx-auto w-96 md:col-span-1">
              ...
              <div className="relative rounded-lg p-6">
                <div className="absolute inset-0 h-80 w-96 rounded-lg border-t-2 border-transparent">
                  <div
                    className="absolute inset-0 top-1/2 bg-linear-to-r from-blue-100 to-red-300 dark:from-blue-500 dark:to-red-900"
                    style={{ filter: "blur(20px)" }}
                  ></div>
                  <div
                    className="absolute inset-0 bg-linear-to-r from-blue-100 dark:from-blue-500 dark:to-purple-500"
                ...
                <div className="relative -top-12">
                  <div className="flex flex-col items-center">
                    <Image
                      ...
                      src={"https://assets.x7finance.org/images/tokens/x7r.png"}
                      alt="X7R image"
                    />
            ...
            <div className="col-span-2 mx-auto w-96 md:col-span-1">
              ...
              <div className="relative rounded-lg p-6">
                <div className="absolute inset-0 h-80 w-96 rounded-lg border-t-2 border-transparent">
                  <div
                    className="absolute inset-0 top-1/2 bg-linear-to-r from-blue-100 to-yellow-300 dark:from-blue-500 dark:to-yellow-900"
                    style={{ filter: "blur(20px)" }}
                  ></div>
                  <div
                    className="absolute inset-0 bg-linear-to-r from-emerald-200 dark:from-emerald-500 dark:to-emerald-500"
                    style={{ mixBlendMode: "multiply" }}
                  ></div>
                </div>
                <div className="relative -top-12">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="relative top-6 flex items-center gap-y-2 md:gap-x-3 md:gap-y-0">
                      ...
                      <LinkInternal
                        prefetch={true}
                        href={`/swap?token0=NATIVE&token1=${X7ContractsEnum.X7DAO(ChainId.ETHEREUM)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className={cn(
                          buttonVariants({
              ...
              <div className="col-span-2 mx-auto">
                ...
                <div className="relative rounded-lg p-6">
                  <div className="absolute inset-0 rounded-lg border-t-2 border-transparent">
                    <div
                      className="absolute inset-0 top-1/2 bg-linear-to-r from-red-200 to-yellow-100 dark:from-red-900 dark:to-yellow-400"
                      style={{ filter: "blur(20px)" }}
                    ></div>
                    <div
                      className="absolute inset-0 bg-linear-to-r from-orange-200 dark:from-orange-500 dark:to-yellow-500"
                      style={{ mixBlendMode: "multiply" }}
                    ></div>
                  </div>
                  <div className="relative -top-12">
          ...
          <div className="mt-8 grid grid-cols-4 gap-4 md:grid-cols-5">
            {quints.map((quint) => (
              ...
              >
                <PioneerDrop height={25} lineColor="to-zinc-500" />
                <div className="relative rounded-lg p-6">
                  <div className="absolute inset-0 rounded-lg border-t-2 border-transparent">
                    <div
                      className="absolute inset-0 top-1/2 bg-linear-to-r from-blue-200 to-amber-300 dark:from-blue-500 dark:to-amber-900"
                      style={{ filter: "blur(20px)" }}
                    ></div>
                    <div
                      className="absolute inset-0 bg-linear-to-r from-emerald-200 to-zinc-200 dark:from-emerald-500 dark:to-zinc-500"
                      style={{ mixBlendMode: "multiply" }}
                    ></div>
                  </div>
                  <div className="relative -top-12">
                    <div className="flex flex-col items-center">
                      ...
                      <div className="relative top-8 flex flex-col items-center gap-y-2">
                        ...
                        <LinkInternal
                          prefetch={true}
                          href={`/swap?token0=NATIVE&token1=${quint.token}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className={cn(
                            buttonVariants({
...
const quints = [
  {
    ...
    description: "",
    link: "",
    token: X7ContractsEnum.X7101(ChainId.ETHEREUM),
  },
  {
    name: "X7102",
    ...
    description: "",
    link: "",
    token: X7ContractsEnum.X7102(ChainId.ETHEREUM),
  },
  {
    name: "X7103",
    ...
    description: "",
    link: "",
    token: X7ContractsEnum.X7103(ChainId.ETHEREUM),
  },
  {
    name: "X7104",
    ...
    description: "",
    link: "",
    token: X7ContractsEnum.X7104(ChainId.ETHEREUM),
  },
  {
    name: "X7105",
