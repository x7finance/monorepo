...
export function CountdownTimer(props: CountdownTimerProps) {
  ...
  return (
    <div className="group relative mt-4 flex items-center justify-center overflow-hidden rounded-lg border border-muted-foreground p-2 text-sm hover:border-muted-foreground hover:bg-muted hover:text-accent-foreground dark:border-muted">
